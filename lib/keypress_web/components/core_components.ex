defmodule KeypressWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(KeypressWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(KeypressWeb.Gettext, "errors", msg, opts)
    # end
